...
parser.add_option("-f", "--filenr",type="int",default=1,
...
parser.add_option("-e","--efficiency", type="float",default=1.,
...
parser.add_option("-l", "--holeice",  default = 50,
                  dest="HOLEICE", help="Pick the hole ice parameterization")
parser.add_option("-s","--scalehad", type="float", default=1.,
                  dest="SCALEHAD",help="Scale light from hadrons")
