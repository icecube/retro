...
tray.AddModule(
    'I3Reader', 'reader', FilenameList=[options.GCDFILE, options.INFILE]
)
...
tray.AddModule(
    RemoveLatePhotons,
    "RemovePhotons",
    InputPhotonSeries="UnweightedPhotons",
    TimeLimit=1E5
) #nanoseconds
...
tray.AddModule(HadLightyield, "scalecascade", Lightyield=options.SCALEHAD)
...
tray.AddModule(
    "I3DOMLaunchCleaning", "launchcleaning"
)(("InIceInput", "InIceRawData_unclean"), ("InIceOutput", "InIceRawData"),
  ("FirstLaunchCleaning", False), ("CleanedKeys", BadDoms))
...
time_shift_args = {
    'I3MCTreeNames': [], 'I3MCPMTResponseMapNames': [],
